...
@section('content')
    <div class="site-blocks-cover overlay" style="background-image: url('/uploads/ven_images/{{ $venue->image }}');" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
